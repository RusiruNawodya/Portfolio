...
const socialLinks = [
  {
    name: "LinkedIn",
    url: "http://www.linkedin.com/in/rusiru-nawodya-38651733b",
    icon: (
  ...
  {
    name: "GitHub",
    url: "https://github.com/RusiruNawodya",
    icon: (
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/rusiru.nawodya.1",
    icon: (
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/rusiru_nawodya?igsh=MW9iOTVvYTlyYzQyag==",
    icon: (
      ...
      <section className="w-full max-w-2xl mx-auto flex flex-col items-center gap-10">
        ...
        <div className="w-full glassmorphism rounded-3xl shadow-2xl p-8 md:p-12 flex flex-col gap-8 animate-slideup">
          <form className="flex flex-col gap-6" onSubmit={handleSubmit} autoComplete="off">
            <div>
              <label htmlFor="name" className="block mb-2 text-sm font-semibold text-indigo-300">Name</label>
              <input
                type="text"
                name="name"
                id="name"
                ...
                className="w-full px-4 py-2 text-lg text-white bg-gray-800 border border-indigo-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none placeholder-gray-500 transition-colors"
                placeholder="Your Name"
                required
              />
            </div>
            <div>
              <label htmlFor="email" className="block mb-2 text-sm font-semibold text-indigo-300">Email</label>
              <input
                type="email"
                name="email"
                id="email"
            ...
            <div>
              <label htmlFor="message" className="block mb-2 text-sm font-semibold text-indigo-300">Message</label>
              <textarea
                name="message"
                id="message"
                value={form.message}
                onChange={handleChange}
                className="w-full px-4 py-2 text-lg text-white bg-gray-800 border border-indigo-400 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none placeholder-gray-500 resize-none min-h-[120px] transition-colors"
            ...
            <button
              type="submit"
              className="mt-2 bg-gradient-to-r from-indigo-500 via-pink-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg transition-all focus:outline-none focus:ring-2 focus:ring-indigo-300 text-lg"
            >
